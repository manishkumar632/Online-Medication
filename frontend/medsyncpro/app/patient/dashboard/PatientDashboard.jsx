...
const MOCK_PRESCRIPTIONS = [
    { id: 1, name: "Metformin 500mg", detail: "1 tablet twice daily • After meals", days: "18 days left", status: "active", color: "var(--pd-teal)" },
    { id: 2, name: "Amlodipine 5mg", detail: "1 tablet daily • Morning", days: "5 days left", status: "refill-needed", color: "var(--pd-orange)" },
    { id: 3, name: "Vitamin D3 60K", detail: "1 capsule weekly • Sunday", days: "3 weeks left", status: "active", color: "var(--pd-blue)" },
    { id: 4, name: "Omeprazole 20mg", detail: "1 capsule daily • Before breakfast", days: "Expired", status: "expired", color: "var(--pd-red)" },
];

const MOCK_TIMELINE = [
    { id: 1, type: "visit", date: "Feb 20, 2026", title: "General Checkup", desc: "Routine check with Dr. Sharma — vitals normal" },
    { id: 2, type: "prescription", date: "Feb 20, 2026", title: "Prescription Updated", desc: "Metformin dosage adjusted to 500mg" },
    { id: 3, type: "lab", date: "Feb 15, 2026", title: "Blood Work Results", desc: "CBC, Lipid panel, HbA1c — all within normal range" },
    { id: 4, type: "diagnosis", date: "Jan 28, 2026", title: "Diagnosis: Pre-diabetes", desc: "HbA1c at 6.2% — lifestyle changes recommended" },
    { id: 5, type: "visit", date: "Jan 10, 2026", title: "Orthopedic Consultation", desc: "Knee pain assessment — MRI ordered" },
];
...
const MOCK_NOTIFICATIONS = [
    { id: 1, type: "appointment", title: "Appointment tomorrow at 10:00 AM", time: "Just now", icon: "📅", bg: "var(--pd-teal-light)" },
    { id: 2, type: "prescription", title: "Amlodipine refill needed in 5 days", time: "1h ago", icon: "💊", bg: "var(--pd-orange-light)" },
    { id: 3, type: "lab", title: "Lab results available for review", time: "3h ago", icon: "🔬", bg: "var(--pd-blue-light)" },
    { id: 4, type: "followup", title: "Follow-up with Dr. Sharma due", time: "Yesterday", icon: "🔔", bg: "var(--pd-purple-light)" },
    { id: 5, type: "system", title: "Profile update completed", time: "2 days ago", icon: "✅", bg: "var(--pd-mint-light)" },
];
                                            ...
                                            <div key={appt.id} className="pd-appt-item">
                                                ...
                                                <div className="pd-appt-info">
                                                    ...
                                                    <div className="appt-detail">
                                                        ...
                                                        <span>•</span>
                                                        <span>{appt.time}</span>
                                                        <span className={`pd-badge ${appt.type}`}>{appt.type === "online" ? "🎥 Online" : "🏥 In-person"}</span>
                                                    </div>
                                                </div>
