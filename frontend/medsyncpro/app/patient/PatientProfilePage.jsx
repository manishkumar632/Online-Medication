                            ...
                            <div className="pp-tags">
                                {allergies.map((a, i) => (
                                    <span key={i} className="pp-tag">
                                        {a}
                                        <button className="pp-tag-remove" onClick={() => { setAllergies(p => p.filter((_, j) => j !== i)); setHasChanges(true); }}>✕</button>
                                    </span>
                                ))}
                            </div>
                            ...
                            <div className="pp-tags">
                                {conditions.map((c, i) => (
                                    <span key={i} className="pp-tag purple">
                                        {c}
                                        <button className="pp-tag-remove" onClick={() => { setConditions(p => p.filter((_, j) => j !== i)); setHasChanges(true); }}>✕</button>
                                    </span>
                                ))}
                            </div>
                            <div className="pp-tag-input">
                                ...
                                {contacts.map(c => (
                                    <div key={c.id} className="pp-contact-item">
                                        ...
                                        <div className="pp-contact-info">
                                            ...
                                            <div className="contact-detail">{c.relation} • {c.phone}</div>
                                        </div>
