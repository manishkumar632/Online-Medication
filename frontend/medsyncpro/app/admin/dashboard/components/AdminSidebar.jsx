...
import {
    LayoutDashboard, Users, Stethoscope, Pill, CalendarCheck, FileText,
    CreditCard, BarChart3, Bell, Settings, ChevronLeft, ChevronRight, Heart, LogOut,
...
const menuItems = [
    ...
    { name: "Appointments", icon: CalendarCheck, href: `${basePath}/appointments` },
...
export default function AdminSidebar({ collapsed, onToggle }) {
    ...
    const isItemActive = (item) => {
        if (item.name === "Dashboard") {
            return pathname === item.href || pathname === basePath || pathname === basePath + "/";
        }
    ...
    return (
        <>
            {!collapsed && <div className="admin-sidebar-overlay" onClick={onToggle} />}
            <aside className={`admin-sidebar ${collapsed ? "collapsed" : ""}`}>
                ...
                <nav className="admin-sidebar-nav">
                    ...
                    {!collapsed && isSettingsPage && (
                        <div className={`admin-settings-dropdown ${settingsOpen ? "open" : ""}`}>
